...
class module(nn.Module):
    def __init__(self, input_size = 50):
        ...
        self.BertModel = BertModel.from_pretrained(CFG['text_model'])
        ...
        self.emo_classifier = nn.Linear(768, 20)
    ...
    def forward(self, context_ids, context_masks, token_type_ids, emo_lable):
        
        context_features = self.BertModel(context_ids, context_masks, token_type_ids).last_hidden_state #batch_size, max_len, 768
        ...
        #v_q_attention_output, _ = self.v_q_attention(context_features, sticker_embedding, sticker_embedding)
        #v_q_attention_output, _ = self.v_q_attention(sticker_embedding, context_features, context_features)
        ...
        v_q_attention_output = self.dropout(context_features)
        ...
        loss = F.cross_entropy(emo_classifier_output, emo_lable) 
        return loss, emo_classifier_output#, intent_classifier_output
