...
with open('/home/ycshi/sticker-sentiment/shared_dataset/dess-llava/odocrti.txt', 'r', encoding='utf-8') as f:
    datas = f.readlines()
for data in datas:
...
def collate_fn(batch):
    context_ids, context_masks, token_type_ids, stickertext_ids, stickertext_masks, stickertext_type_ids,  emo_lable =[],[],[], [], [], [], []
    ...
    for x in batch:
        ...
        sticker_text = dess[x['image']]
        # 将文本转化为token
        token = tokenizer(sticker_text,padding='max_length', truncation=True, max_length=CFG['max_len'],return_tensors='pt')
        ...
        emo_lable.append(x['multimodal_label'])
    ...
    return context_ids, context_masks, token_type_ids, stickertext_ids , stickertext_masks, stickertext_type_ids, emo_lables 
