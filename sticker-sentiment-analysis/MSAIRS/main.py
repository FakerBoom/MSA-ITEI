...
#with open('/home/ycshi/sticker-sentiment/shared_dataset/easy_task/train.json', encoding='utf-8') as f:
    #train = json.load(f)
#with open('/home/ycshi/sticker-sentiment/shared_dataset/easy_task/test.json', encoding='utf-8') as f:
    #valid = json.load(f)
#with open('/home/ycshi/sticker-sentiment/shared_dataset/hard_task3/test.json', encoding='utf-8') as f:
    #test = json.load(f)

train,valid = get_data('/home/ycshi/sticker-sentiment/ourdata/rewrite.json')
    ...
    for epoch in range(1,eopchs):
        ...
        with tqdm(total=len(train_loader), desc=f'Train Epoch {epoch}/{eopchs}', unit='batch', ascii=True) as pbar:
            for batch in train_loader:
                context_ids, context_masks, token_type_ids, emo_lable = batch
                ...
                loss, emo_classifier_output= model(context_ids, context_masks, token_type_ids,emo_lable )
